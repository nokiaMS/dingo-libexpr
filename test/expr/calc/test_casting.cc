...
TEST(TestOtherToDecimalP, Cast) {
  ...
  ASSERT_EQ((calc::Cast<float>(DecimalP("123456.123456789"))), 123456.125);
  ASSERT_EQ((calc::Cast<double>(DecimalP("123456.123456789"))), 123456.12345678899);
  ASSERT_EQ((calc::Cast<float>(DecimalP("-123456.123456789"))), -123456.125);
  ASSERT_EQ((calc::Cast<double>(DecimalP("-123456.123456789"))), -123456.12345678899);
  ASSERT_EQ((calc::Cast<float>(DecimalP("0"))), 0);
